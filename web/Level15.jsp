...
<form action="LevelCompleteProcess.jsp" method="post">
    ...
    <script>
        function right(number) {
            ...
            for (loop = 1; loop <= 5; loop++) {
                if (document.getElementById("mine").rows[number].cells[loop].firstElementChild !== null) {
                    document.getElementById("mine").rows[number].cells[loop].removeChild(document.getElementById("mine").rows[number].cells[loop].firstElementChild);
                    index.push(loop);
                }
            }
            ...
            for (loop = 0; loop < index.length; loop++) {
                ...
                var i = index[loop];
                if (i !== 5) {
                    document.getElementById("mine").rows[number].cells[i + 1].appendChild(image);
                } else {
                    document.getElementById("mine").rows[number].cells[1].appendChild(image);
                }
            }
        ...
        function left(number) {
            ...
            for (loop = 0; loop < index.length; loop++) {
                ...
                if (i !== 1) {
                    ...
                    document.getElementById("mine").rows[number].cells[5].appendChild(image);
                }
            }
        ...
        function up(number) {
            ...
            var loop;
            for (loop = 1; loop <= 5; loop++) {
                if (document.getElementById("mine").rows[loop].cells[number].firstElementChild !== null) {
                    document.getElementById("mine").rows[loop].cells[number].removeChild(document.getElementById("mine").rows[loop].cells[number].firstElementChild);
                    index.push(loop);
                }
            }
            ...
            for (loop = 0; loop < index.length; loop++) {
                ...
                var i = index[loop];
                if (i !== 1) {
                    document.getElementById("mine").rows[i - 1].cells[number].appendChild(image);
                } else {
                    document.getElementById("mine").rows[5].cells[number].appendChild(image);
                }
            }
        ...
        function down(number) {
            ...
            for (loop = 0; loop < index.length; loop++) {
                ...
                if (i !== 5) {
                    ...
                    document.getElementById("mine").rows[1].cells[number].appendChild(image);
                }
            }
    ...
    <center>
        <TABLE width="150" height="150" border="0" id="end">
            ...
            <TR height="30">
                <TD width="30" bgcolor="#9370db"><IMG src="star2.jpg" border="0"/></TD>
                <TD width="30" bgcolor="#9370db"><IMG src="star2.jpg" border="0"/></TD>
                <TD width="30" bgcolor="#9370db"><IMG src="star2.jpg" border="0"/></TD>
                <TD width="30" bgcolor="#9370db"><IMG src="star2.jpg" border="0"/></TD>
                <TD width="30" bgcolor="#9370db"><IMG src="star2.jpg" border="0"/></TD>
    ...
    <center>
        ...
        <input type="hidden" name="level" value="15">
